...
<table>
  <tr>
    <td>
        <a  style="text-decoration:none";href="https://blog.csdn.net/yao09605/article/details/104622655/">概率图的推断——变量消除、信念传播、因子图、道德图、联结树</a>
      </td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a  style="text-decoration:none";href="https://blog.csdn.net/sinat_38151275/article/details/83621805">因子图与和积算法简介(CSDN)</a>
      </td>
  </tr>
  <tr>
      <td>出自论文<strong>factor graph and sum-product algorithm</strong>。</td>
  </tr>
  <tr>
    <td><a  style="text-decoration:none";href="https://zhuanlan.zhihu.com/p/84210564">因子图与和积算法简介(知乎)</a></td>
  </tr>
  <tr>
    <td>出自论文<strong>factor graph and sum-product algorithm</strong>。与上一个链接内容相比，对因子图定义的形式化描述更多。</td>
  </tr>
<table>
