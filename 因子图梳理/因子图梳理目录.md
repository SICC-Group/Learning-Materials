...
<table>
  <tr>
    <td>[论文]**An introduction to factor graph**</td>
  </tr>
  <tr>
    <td>本文讲述因子图的发展过程，并给出两种形式的因子图：标准形式、Forney形式。 介绍了LDPC码、卡尔曼滤波等应用与因子图上的例子。</td>
  </tr>
  <tr>
    <td>[论文]**factor graph and sum-product algorithm**</td>
  </tr>
  <tr>
...
<table>
  <tr>
    <td>[论文]**Max-product for maximum weight matching   Convergence correctness and LP duality**</td>
  </tr>
  <tr>
    <td>本文介绍最大积算法并证明其在循环图中的正确性和收敛性</td>
  </tr>
  <tr>
    <td>[论文]**Message-passing algorithms for inference**</td>
  </tr>
  <tr>
